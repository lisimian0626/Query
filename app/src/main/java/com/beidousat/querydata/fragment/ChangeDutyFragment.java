...
public class ChangeDutyFragment extends BaseFragment{
    private String  title;
    public static ChangeDutyFragment newInstance(String title){
        ChangeDutyFragment pf=new ChangeDutyFragment();
