...
public class WidgetPage extends RelativeLayout implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_pre:
                L.d(getClass().getSimpleName(), "onClick tv_pre ");
                ...
                break;
            case R.id.tv_next:
                L.d(getClass().getSimpleName(), "onClick tv_next ");
                if (mOnPageChangedListener != null) {
                ...
                break;
            case R.id.tv_first:
                L.d(getClass().getSimpleName(), "onClick tv_first ");
...
//        if (mCurrent + 1 < mTotal)
    ...
    private void checkButtonStatus() {
        ...
        L.d(getClass().getSimpleName(), "checkButtonStatus mTotal:" + mTotal + "  mCurrent:" + mCurrent);
        if (mTotal > 1) {
            if (mCurrent > 0) {
